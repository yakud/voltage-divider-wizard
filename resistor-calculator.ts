...
const resistorsInOhms: ResistorType[] = [
  { value: 240, name: "240Ω" },
  { value: 470, name: "470Ω" },
  { value: 510, name: "510Ω" },
...
export function calculateVoltageDivider(inputVoltage: number, outputVoltage: number, maxResistorsCount: number): { gndNetwork: string; vccNetwork: string; actualVoltage: number; error: number } {
